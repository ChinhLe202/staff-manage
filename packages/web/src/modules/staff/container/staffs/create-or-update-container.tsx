...
export const CreateOrUpdateStaffContainer = ({ initialData, onCancel, onSubmit }: FormStaffProps) => {
    const {} = useStaffContext();
    const { formData, setFormData, resetFormData, validateForm, errorMessage, handleSubmit } =
            ...
            <div className='flex gap-4'>
                ...
                <div className='-ml-11'>
                    <div className='mb-[6px] grid grid-cols-2 items-center gap-2 text-[16px]'>
                        <span className='col-span-1 text-right text-lg font-medium text-[#000]'>Họ và tên:</span>
                        <input
                            type='text'
                            id='fullName'
                            name='fullName'
                    ...
                    <div className='mb-[2px] grid grid-cols-2 items-center gap-2'>
                        <span className='col-span-1 text-right text-md text-[#000]'>Email:</span>
                        <input
                            type='email'
                            id='email'
                            name='email'
                    ...
                    <div className='mb-[2px] grid grid-cols-2 items-center gap-2 text-md'>
                        <span className='col-span-1 text-right text-md text-[#000] font-normal'>Điện thoại:</span>
                        <input
                            type='text'
                            id='phone'
                            name='phone'
                    ...
                    <div className='mb-[2px] grid grid-cols-2 items-center gap-2 text-md'>
                        <span className='col-span-1 text-right text-md text-[#000]'>Tên đăng nhập:</span>
                        <input
                            type='text'
                            id='username'
                            name='username'
                    ...
                    <div className='mb-[2px] grid grid-cols-2 items-center gap-2 text-md'>
                        <span className='col-span-1 text-right text-md text-[#000]'>Mật khẩu:</span>
                        <input
                            type='password'
                            id='password'
                            name='password'
                    ...
                    <div className='mb-4 grid grid-cols-2 items-center gap-2 text-md'>
                        <span className='col-span-1 text-right text-md text-[#000]'>Nhập lại mật khẩu:</span>
                        <input
                            type='password'
                            id='confirmPassword'
                    ...
                    <div className='mb-4 grid items-center'>
                        {errorMessage && <div className='mt-2 text-sm text-red-500 text-right'>{errorMessage}</div>}
                    </div>
                </div>
            </div>
